...
export const QuizOneByOne: Story = {
  args: {
    ...
    cards: mockQuizCards,
    seo: mockSeo,
    siblingTopics: mockSiblingTopics,
    showType: 'one-by-one',
    shouldShowReviewResults: true,
  },
};

// Quiz Exercise - Show All
...
// Spelling Exercise
export const SpellingExercise: Story = {
  args: {
    "topic": {
...
export const ParagraphGame: Story = {
  args: {
    ...
    exercise: {
      ...
      description: 'Read and answer questions about the paragraph',
    },
    cards: mockParaGameCards,
    seo: {
      ...mockSeo,
      titleH1: 'Reading Comprehension Exercise',
    },
    siblingTopics: mockSiblingTopics,
    showType: 'one-by-one',
    shouldShowReviewResults: true,
...
export const MixedExercise: Story = {
  args: {
    topic: mockTopic,
    exercise: {
      ...mockExercise,
      name: 'Mixed Grammar Exercise',
      description: 'Practice with different types of questions',
    },
    cards: [...mockQuizCards.slice(0, 2), mockSpellingCards[0], mockParaGameCards[0]],
    seo: {
      ...mockSeo,
      titleH1: 'Mixed Grammar Exercise',
    },
    siblingTopics: mockSiblingTopics,
    showType: 'one-by-one',
    shouldShowReviewResults: true,
...
// Without Review Results
export const WithoutReviewResults: Story = {
  args: {
    topic: mockTopic,
    exercise: mockExercise,
    cards: mockQuizCards,
    ...
    siblingTopics: mockSiblingTopics,
    showType: 'one-by-one',
    shouldShowReviewResults: false,
  },
};

// Empty Exercise
export const EmptyExercise: Story = {
  args: {
    topic: mockTopic,
    exercise: mockExercise,
    cards: [],
